...
// <custom:imports>
const IntentEventAnlegenPage = lazy(() => import('@/pages/intents/EventAnlegenPage'));
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/event-anlegen" element={<Suspense fallback={null}><IntentEventAnlegenPage /></Suspense>} />
