  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'skill_level': (
      <div key="skill_level" className="space-y-1.5">
        <Label htmlFor="skill_level">Schwierigkeitsgrad <span className="text-destructive" aria-hidden="true">*</span></Label>
        <div role="radiogroup" className="flex flex-wrap gap-1.5">
          <button
            type="button"
            role="radio"
    ...
    'location': (
      <div key="location" className="space-y-1.5">
        ...
        <Combobox
          ...
          createLabel="Neu in Skateparks & Veranstaltungsorte"
        />
    ...
    'organizer_email': (
      <div key="organizer_email" className="space-y-1.5">
        <Label htmlFor="organizer_email">E-Mail des Organisators <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="organizer_email"
          type="email"
          placeholder=""
