...
export function EventVerwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, skateparksVeranstaltungsorteList, enablePhotoScan = true, enablePhotoLocation = true }: EventVerwaltungDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'event_title': (
      <div key="event_title" className="space-y-1.5">
        ...
        <Input
          id="event_title"
          placeholder="z. B. Streetskate Battle 2024"
    ...
    'event_description': (
      <div key="event_description" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Veranstaltungsablauf, Regeln, Highlights..."
    ...
    'event_datetime': (
      <div key="event_datetime" className="space-y-1.5">
        ...
        <Input
          id="event_datetime"
          placeholder="z. B. 2024-09-15 oder 14:30"
          value={fields.event_datetime ?? ''}
          onChange={e => setFields(f => ({ ...f, event_datetime: e.target.value }))}
          required
        />
  ...
  const FIELD_LABELS: Record<string, string> = {"event_title": "Titel des Events", "event_description": "Beschreibung", "event_category": "Kategorie", "event_datetime": "Datum", "skill_level": "Schwierigkeitsgrad", "max_participants": "Maximale Teilnehmerzahl", "entry_fee": "Startgebühr (in €)", "location": "Veranstaltungsort", "organizer_firstname": "Vorname des Organisators", "organizer_lastname": "Nachname des Organisators", "organizer_email": "E-Mail des Organisators", "organizer_phone": "Telefonnummer des Organisators", "event_flyer": "Event-Flyer"};
