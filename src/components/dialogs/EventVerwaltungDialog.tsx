  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'event_title': (
      <div key="event_title" className="space-y-1.5">
        ...
        <Input
          id="event_title"
          placeholder="z. B. Berlin Skateboard Jam"
    ...
    'event_description': (
      <div key="event_description" className="space-y-1.5">
        ...
        <Textarea
          ...
          placeholder="Ablauf, Regeln, Highlights der Veranstaltung..."
