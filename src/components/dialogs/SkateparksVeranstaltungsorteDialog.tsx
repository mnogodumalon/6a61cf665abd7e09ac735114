  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'location_name': (
      <div key="location_name" className="space-y-1.5">
        ...
        <Input
          id="location_name"
          placeholder="z. B. Kreuzberg Skatepark"
    ...
    'street': (
      <div key="street" className="space-y-1.5">
        ...
        <Input
          id="street"
          placeholder="z. B. Köpenicker Str."
          value={fields.street ?? ''}
    ...
    'description': (
      <div key="description" className="space-y-1.5">
        ...
        <Textarea
          id="description"
          placeholder="Ausstattung, Hindernisse, Besonderheiten..."
    ...
    'special_notes': (
      <div key="special_notes" className="space-y-1.5">
        ...
        <Textarea
          id="special_notes"
          placeholder="Öffnungszeiten, Regeln, Besonderheiten..."
