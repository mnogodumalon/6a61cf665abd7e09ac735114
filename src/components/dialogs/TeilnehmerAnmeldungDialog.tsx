  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'participant_email': (
      <div key="participant_email" className="space-y-1.5">
        <Label htmlFor="participant_email">E-Mail-Adresse <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
    ...
    'emergency_contact_phone': (
      <div key="emergency_contact_phone" className="space-y-1.5">
        <Label htmlFor="emergency_contact_phone">Telefonnummer des Notfallkontakts <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
    ...
    'waiver_accepted': (
      <div key="waiver_accepted" className="space-y-1.5">
        <Label htmlFor="waiver_accepted">Ich akzeptiere die Teilnahmebedingungen <span className="text-destructive" aria-hidden="true">*</span></Label>
