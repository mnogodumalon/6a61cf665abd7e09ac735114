...
export function TeilnehmerAnmeldungDialog({ open, onClose, onSubmit, defaultValues, recordId, eventVerwaltungList, enablePhotoScan = true, enablePhotoLocation = true }: TeilnehmerAnmeldungDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'tshirt_size': (
      <div key="tshirt_size" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="tshirt_size" className="max-sm:h-11"><SelectValue placeholder="z. B. M, L oder XL" /></SelectTrigger>
          <SelectContent>
  ...
  const APPLOOKUP_LABELS: Record<string, Record<string, string>> = {"event": {"organizer_notes": "Notizen", "event_title": "Titel des Events", "event_description": "Beschreibung", "event_category": "Kategorie", "event_datetime": "Datum und Uhrzeit", "skill_level": "Schwierigkeitsgrad", "max_participants": "Maximale Teilnehmerzahl", "entry_fee": "Startgebühr (in €)", "location": "Veranstaltungsort", "organizer_firstname": "Vorname des Organisators", "organizer_lastname": "Nachname des Organisators", "organizer_email": "E-Mail des Organisators", "organizer_phone": "Telefonnummer des Organisators", "event_flyer": "Event-Flyer"}};
