  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'emergency_contact_email': (
      <div key="emergency_contact_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          placeholder="z. B. peter@example.de"
    ...
    'event': (
      <div key="event" className="space-y-1.5">
        ...
        <Combobox
          id="event"
          placeholder="Zu welchem Event meldest du dich an?"
    ...
    'tshirt_size': (
      <div key="tshirt_size" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="tshirt_size" className="max-sm:h-11"><SelectValue placeholder="Welche Größe passt dir?" /></SelectTrigger>
          <SelectContent>
