  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'emergency_contact_email': (
      <div key="emergency_contact_email" className="space-y-1.5">
        ...
        <Input
          ...
          type="email"
          placeholder="z. B. notfall@example.de"
    ...
    'emergency_contact_name': (
      <div key="emergency_contact_name" className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="z. B. Eltern oder enger Freund"
    ...
    'tshirt_size': (
      <div key="tshirt_size" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="tshirt_size" className="max-sm:h-11"><SelectValue placeholder="Welche Größe?" /></SelectTrigger>
          <SelectContent>
