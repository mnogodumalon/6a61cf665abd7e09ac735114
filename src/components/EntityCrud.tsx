 ...
 *   event_verwaltung: event_title, event_description, event_category, event_datetime, skill_level, max_participants, entry_fee, location, …  ·  → skateparks_veranstaltungsorte · ← teilnehmer_anmeldung (list + contextual +)
...
export interface EntityCrud {
  ...
  enriched: { skateparksVeranstaltungsorte: SkateparksVeranstaltungsorte[]; eventVerwaltung: EnrichedEventVerwaltung[]; teilnehmerAnmeldung: EnrichedTeilnehmerAnmeldung[] };
}
...
export function useEntityCrud(data: EntityCrudData, options?: EntityCrudOptions): EntityCrud {
      ...
      <RecordOverlayHost
        ...
        render={(top) => {
          ...
          if (top.type === 'eventVerwaltung') {
            return (
              <>
                <RecordHeader title={top.record.fields.event_title ?? appLabel('event_verwaltung')} subtitle={undefined} />
  ...
  return {
    ...
    enriched: { skateparksVeranstaltungsorte: data.skateparksVeranstaltungsorte, eventVerwaltung: enrichedEventVerwaltung, teilnehmerAnmeldung: enrichedTeilnehmerAnmeldung },
  };
}
