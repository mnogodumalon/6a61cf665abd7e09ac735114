...
const PROXY_BASE = '';
const APP_ID = '6a61cf45b2071fe2be39980d';
...
export default function PublicFormSkateparksVeranstaltungsorte() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Skateparks & Veranstaltungsorte — Formular</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          <div className="space-y-2">
            <Label htmlFor="location_name">Name des Veranstaltungsorts *</Label>
            <Input
              id="location_name"
              placeholder=""
