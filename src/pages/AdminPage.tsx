...
const EVENTVERWALTUNG_FIELDS = [
  ...
  { key: 'event_category', label: 'Kategorie', type: 'lookup/select', options: [{ key: 'jam_session', label: 'Jam Session' }, { key: 'demo', label: 'Demo' }, { key: 'contest', label: 'Contest' }, { key: 'workshop', label: 'Workshop' }, { key: 'sonstiges', label: 'Sonstiges' }] },
