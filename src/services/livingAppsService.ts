...
import type { SkateparksVeranstaltungsorte, TeilnehmerAnmeldung, EventVerwaltung, CreateSkateparksVeranstaltungsorte, CreateTeilnehmerAnmeldung, CreateEventVerwaltung } from '@/types/app';
...
export class LivingAppsService {
  ...
  static async getSkateparksVeranstaltungsorte(): Promise<SkateparksVeranstaltungsorte[]> {
    ...
    return hydrateRecords(records, 'skateparks_veranstaltungsorte');
  }
  static async getSkateparksVeranstaltungsorteEntry(id: string): Promise<SkateparksVeranstaltungsorte | undefined> {
    ...
    return hydrateRecords([record], 'skateparks_veranstaltungsorte')[0];
  }
  ...
  static async getTeilnehmerAnmeldung(): Promise<TeilnehmerAnmeldung[]> {
    ...
    return hydrateRecords(records, 'teilnehmer_anmeldung');
  }
  static async getTeilnehmerAnmeldungEntry(id: string): Promise<TeilnehmerAnmeldung | undefined> {
    ...
    return hydrateRecords([record], 'teilnehmer_anmeldung')[0];
  }
