...
import type { SkateparksVeranstaltungsorte, EventVerwaltung, TeilnehmerAnmeldung, CreateSkateparksVeranstaltungsorte, CreateEventVerwaltung, CreateTeilnehmerAnmeldung } from '@/types/app';
