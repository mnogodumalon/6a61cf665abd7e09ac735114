...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['event_title', 'event_category', 'event_datetime', 'skill_level', 'max_participants', 'entry_fee', 'location', { row: ['organizer_firstname', 'organizer_lastname'], cols: '1fr 1fr' }, 'organizer_email', 'organizer_phone', 'event_description'],
  defaults: {},
  computed: {},
};
