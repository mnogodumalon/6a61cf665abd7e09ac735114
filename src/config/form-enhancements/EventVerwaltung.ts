...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['event_title', 'event_category', 'event_datetime', 'skill_level', 'location', 'max_participants', 'entry_fee', { row: ['organizer_firstname', 'organizer_lastname'] }, 'organizer_email', 'organizer_phone', 'event_description'],
  defaults: {
    'event_category': { kind: 'lookup', key: 'contest', label: 'Contest' },
