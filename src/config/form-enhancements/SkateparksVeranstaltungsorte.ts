// Auto-generated. Per-entity form-enhancements config for "Skateparks & Veranstaltungsorte".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['location_name', { row: ['street', 'house_number'], cols: '2fr 1fr' }, { row: ['postal_code', 'city'], cols: '1fr 2fr' }, 'description', 'special_notes'],
  defaults: {},
  computed: {},
};
