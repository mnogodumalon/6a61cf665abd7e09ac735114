...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    'event',
    { row: ['participant_firstname', 'participant_lastname'], cols: '1fr 1fr' },
    'participant_email',
    'participant_phone',
    'date_of_birth',
  ...
  defaults: {
    'participant_skill_level': { kind: 'lookup', key: 'beginner', label: 'Anfänger' },
    'waiver_accepted': { kind: 'literal', value: true },
  },
  computed: {},
};
