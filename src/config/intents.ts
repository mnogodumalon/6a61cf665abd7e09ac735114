...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/event-anlegen', label: { de: 'Event anlegen', en: 'Create event' }, icon: IconCalendarPlus, description: 'Neues Skateboard-Event in 2 Schritten erstellen und Veranstaltungsort verknüpfen' },
  { path: '/intents/teilnehmer-anmelden', label: { de: 'Teilnehmer anmelden', en: 'Register participant' }, icon: IconUserPlus, description: 'Teilnehmer für ein bestehendes Event anmelden' },
  // </custom:intents>
];
