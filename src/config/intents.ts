...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/event-anlegen', label: { de: 'Event anlegen', en: 'Create event' }, icon: IconCalendarPlus, description: 'Neues Skatepark-Event in 2 Schritten anlegen' },
  { path: '/intents/teilnehmer-anmelden', label: { de: 'Teilnehmer anmelden', en: 'Register participant' }, icon: IconUserPlus, description: 'Teilnehmer fuer ein Event in 3 Schritten anmelden' },
  // </custom:intents>
];
