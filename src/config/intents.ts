...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/event-anlegen', label: { de: 'Event anlegen', en: 'Create event' }, icon: IconCalendarPlus, description: 'Neues Skatepark-Event in zwei Schritten erstellen' },
  { path: '/intents/teilnehmer-anmelden', label: { de: 'Teilnehmer anmelden', en: 'Register participant' }, icon: IconUserPlus, description: 'Teilnehmer für ein Event registrieren' },
  // </custom:intents>
];
