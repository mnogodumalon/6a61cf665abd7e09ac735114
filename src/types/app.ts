...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  'event_verwaltung': {
    event_category: [{ key: "contest", get label() { return lookupLabel('event_verwaltung', 'event_category', "contest") ?? "Contest"; } }, { key: "jam_session", get label() { return lookupLabel('event_verwaltung', 'event_category', "jam_session") ?? "Jam Session"; } }, { key: "demo", get label() { return lookupLabel('event_verwaltung', 'event_category', "demo") ?? "Demo"; } }, { key: "workshop", get label() { return lookupLabel('event_verwaltung', 'event_category', "workshop") ?? "Workshop"; } }, { key: "sonstiges", get label() { return lookupLabel('event_verwaltung', 'event_category', "sonstiges") ?? "Sonstiges"; } }],
